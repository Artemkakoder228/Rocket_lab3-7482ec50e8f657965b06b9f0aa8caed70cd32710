...
window.treeNodes = [
    ...
    { 
        id: 'hull_mk2', name: 'Композитний Корпус', tier: 'V', 
        desc: 'Надміцний сплав, здатний витримати колосальний тиск.', 
        x: 1250, y: 1000, req: 'hull_start', owned: false, img: 'images/Korpus.png',
        cost: { hydrogen: 3000, helium: 2000, coins: 8000 }
    },
    { 
        id: 'solar_upg', name: 'Фотоелементи MK-2', tier: 'VII', 
        desc: 'Уловлювачі слабкого сонячного світла на віддаленій орбіті.', 
        x: 1500, y: 850, req: 'hull_mk2', owned: false, img: 'images/Bataries.png',
        cost: { hydrogen: 4000, helium: 2500, coins: 10000 }
    },
    { 
        id: 'solar_max', name: 'Квантові Панелі', tier: 'VIII', 
        desc: 'Пік технологій поглинання енергії в глибокому космосі.', 
        x: 1750, y: 850, req: 'solar_upg', owned: false, img: 'images/Bataries.png',
        cost: { hydrogen: 6000, helium: 4000, coins: 15000 }
    },
    { 
        id: 'aux_bay', name: 'Допоміжні Відсіки', tier: 'V', 
        desc: 'Розширення простору для систем життєзабезпечення.', 
        x: 1500, y: 1150, req: 'hull_mk2', owned: false, img: 'images/Korpus.png',
        cost: { hydrogen: 3500, helium: 2500, coins: 7500 }
    },
    { 
        id: 'combat_bay', name: 'Бойовий Модуль', tier: 'VI', 
        desc: 'Броньований відсік з автоматичною системою наведення.', 
    ...
    { 
        id: 'eng_ultimate', name: 'Гіпер-Турбіна', tier: 'V', 
        desc: 'Максимальна тяга для подолання орбітального тяжіння.', 
        x: 1250, y: 1300, req: 'eng_start', owned: false, img: 'images/Turbina.png',
        cost: { hydrogen: 9000, helium: 7000, coins: 18000 }
    },
    { 
        id: 'eng_side', name: 'Бокові Рушії', tier: 'IV', 
        desc: 'Потужні маневрові прискорювачі для ухилення від штормів.', 
        x: 1250, y: 1500, req: 'eng_start', owned: false, img: 'images/Turbina.png',
    ...
    { 
        id: 'nose_adv', name: 'Аеро-Композит', tier: 'V', 
        desc: 'Найсучасніший ніс, що витримує будь-яке тертя.', 
        x: 1250, y: 1700, req: 'nose_start', owned: false, img: 'images/Nose.png',
...
window.addEventListener('touchmove', (e) => {
    ...
    if (e.cancelable) e.preventDefault(); // Блокуємо скрол самої сторінки
...
function openPanel(node) {
    ...
    if (node.owned) {
        ...
        // РЕСУРСИ ЮПІТЕРА
        const hydrogenVal = c.hydrogen || 0;
        const heliumVal = c.helium || 0;
